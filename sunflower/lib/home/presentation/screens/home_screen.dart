      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              theme,
              'Как природа решает математическую задачу',
            ...
            _buildSection(
              ...
              'Что если немного изменить угол? Природа методом проб и ошибок нашла оптимальное значение, но мы можем смоделировать альтернативные сценарии:',
            ),
            _buildAngleComparisonCard(
              context,
              angle: '137.45° (21/55)',
              description:
                  'Здесь проявляется магия рациональных чисел. Поскольку 21/55 — дробь, спирали со временем "синхронизируются", '
            ...
            _buildAngleComparisonCard(
              ...
              description:
                  'Абсолютный чемпион по упаковке. Иррациональность φ² гарантирует, что ни одно семя никогда не окажется '
                  'точно над другим, как бы далеко ни рос цветок. Спирали плавно "убегают" друг от друга, создавая гипнотический двойной узор '
                  'из 34 и 55 рукавов — соседних чисел Фибоначчи. Здесь η достигает максимума ≈ 0.8169.',
